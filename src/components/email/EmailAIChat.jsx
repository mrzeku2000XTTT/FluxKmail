...
export default function EmailAIChat({ email, walletAddress, isOpen, onOpenChange }) {
  ...
  const createConversation = async () => {
    try {
      ...
      // Send initial context message with email details for AI context
      const contextMessage = `[CONTEXT FOR AI - This is an email I'm viewing]
Subject: ${email.subject}
...
[Please greet me and offer to help me understand this email. Be conversational and friendly.]`;
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages
                .filter(msg => msg.content && !msg.content.startsWith('[CONTEXT FOR AI')) // Filter out context messages
                .map((msg, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div
                    className={`max-w-[85%] rounded-2xl px-4 py-2 break-words overflow-wrap-anywhere ${
                      msg.role === 'user'
